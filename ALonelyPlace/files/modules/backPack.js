    ...
    toggleBackPackMenu(userData)
    {
        ...
        if(this.toggled == false)
        {
            ...
            for(var i = 0; i < allItems.length; i++)
            {
                ...
                {
                    $('body').append(`<div class="infoText ${getSlotFromItem(this.innerHTML)}" style="position:absolute;width:200px;height:200px;top:${event.clientY}px;left:${event.clientX}px;">
